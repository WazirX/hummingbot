...
class WazirxAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def _trade_update_event(self):
        resp = {
            ...
            "stream": f"{self.ex_trading_pair}@trades"
        }
        return resp
    ...
    def _order_diff_event(self):
        resp = {
            ...
            "stream": f"{self.ex_trading_pair}@depth"
        }
        return resp
    ...
    def test_get_new_order_book_successful(self, mock_api):
        ...
        self.assertEqual(9253.0, bids[0].price)
        self.assertEqual(1.0456, bids[0].amount)
        self.assertEqual(expected_update_id, bids[0].update_id)
        self.assertEqual(1, len(asks))
        self.assertEqual(9291.0, asks[0].price)
        self.assertEqual(0.0119, asks[0].amount)
    ...
    def test_listen_for_subscriptions_subscribes_to_trades_and_order_diffs(self, ws_connect_mock):
        ...
        result_subscribe_trades = {
            "code": 500,
            "message": "Invalid request: could not parse message", "id": 0
        }
        ...
        expected_trade_subscription = {
            "event": "subscribe",
            "streams": [f"{self.ex_trading_pair.lower()}@trades"]}
        self.assertEqual(expected_trade_subscription, sent_subscription_messages[0])
        expected_diff_subscription = {
            "event": "subscribe",
            "streams": [f"{self.ex_trading_pair.lower()}@depth10@100ms"]}
    ...
    def test_listen_for_trades_successful(self):
        ...
        self.assertEqual(17376030, msg.trade_id)
    ...
    def test_listen_for_order_book_diffs_successful(self):
        ...
        self.assertEqual(diff_event["data"]["E"], msg.update_id)
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.wazirx.wazirx_api_order_book_data_source"
           ".WazirxAPIOrderBookDataSource._sleep")
    ...
    def test_listen_for_order_book_snapshots_successful(self, mock_api, ):
        ...
        self.assertEqual(1588831243, msg.update_id)
